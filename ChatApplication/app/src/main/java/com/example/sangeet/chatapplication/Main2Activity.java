...
import com.example.sangeet.chatapplication.Activities.ChatActivity;
import com.example.sangeet.chatapplication.Activities.ConversationActivity;
import com.example.sangeet.chatapplication.Adapters.UserProfilesMenuAdapter;
import com.example.sangeet.chatapplication.Authentication.LoginActivity;
...
public class Main2Activity extends AppCompatActivity implements UserProfilesMenuAdapter.ListItemClickListner {
    static {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuAdapter = new UserProfilesMenuAdapter(userList,Main2Activity.this);
    ...
    public void onListItemClick(User clickedUser) {
        Intent intent=new Intent(Main2Activity.this,ConversationActivity.class);
