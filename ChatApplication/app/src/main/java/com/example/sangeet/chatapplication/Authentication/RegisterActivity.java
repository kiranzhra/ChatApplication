package com.example.sangeet.chatapplication.Authentication;
...
import com.example.sangeet.chatapplication.Main2Activity;
    ...
    private void onAuthSuccess(final FirebaseUser firebaseUser){
        ...
        profilePicRef.putFile(selectedProfileImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                writeNewUser(firebaseUser.getUid(),inputName.getText().toString(),firebaseUser.getEmail(),downloadUri);
            }
        });
